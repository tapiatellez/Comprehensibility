...
def get_frequency(concept, paragraph, paragraphs_occurrences_weighted):
        ...
        if paragraphs_occurrences_weighted[paragraph]:
            #print("Paragraph does contain objects.")
            if concept in paragraphs_occurrences_weighted[paragraph].keys():
                #print("If the concept is in the list of concepts of the paragraph.")
                #print("Return: ", paragraphs_occurrences_weighted[paragraph][concept])
...
def get_comprehension_burden_per_concept(concept, key_paragraph, related_concepts_dictionary, paragraph_recurrences, paragraphs_occurrences_weighted):
    ...
    for paragraph in paragraph_recurrences.keys():
        #print("Summatory for concept: ", sum_concept)
...
for i in range(1, 6):
    ...
    print("Thesis: ", i)
    print(theses[i])
    theses_five.append(theses[i])
#   Obtain sections
print("---------------------------------------------------")
print("theses_five[0]: ")
print(theses_five[0])
sections = obtainSections(str(theses_five[0]))
print("Sections: ", sections)
#   Check for the five selected theses
output_file = open("comprensibilidad_cinco.txt", "w+")
counter = 1
output_string = ""
for thesis in theses_five:
