...
print(justificacionTSU)
#Obtaining the dictionary with the relation justification-position-word
...
#Removes the empty justifications
...
print("TSU: ",sizesTSU)
print("Lic: ", sizesLic)
print("Maestria: ",sizesMaestria)
print("Doctorado: ", sizesDoctorado)
#
...
print(eightyRelFreqMatrixTSU['Justificacion13'])
print(eightyRelFreqMatrixLic["Justificacion13"])
print(eightyRelFreqMatrixMaestria["Justificacion13"])
print(eightyRelFreqMatrixDoctorado["Justificacion13"])
#We obtain the most common words frequency provided by RAE
...
print(eightyLogFreqMatrixTSU["Justificacion13"])
print(eightyLogFreqMatrixLic["Justificacion13"])
print(eightyLogFreqMatrixMaestria["Justificacion13"])
print(eightyLogFreqMatrixDoctorado["Justificacion13"])
#
