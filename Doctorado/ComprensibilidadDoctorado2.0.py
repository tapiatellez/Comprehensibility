...
#   The following function receives a dictionary with the form: sec-par-sen and
#   creates a dictionary of the for sec-par-sen-concepts.
def get_concepts_by_matching_sv(s_dictionary):
    concept_dictionary = {}
    concepts = []
    pattern1 = [{"POS": "NOUN"}, {"POS":"ADJ"}, {"POS": "ADJ"}, {"POS": "ADJ"}]
    pattern2 = [{"POS": "ADJ"}, {"POS": "NOUN"}, {"POS": "ADJ"}, {"POS": "ADJ"}]
    pattern3 = [{"POS": "NOUN"}, {"POS": "ADP"}, {"POS": "DET"}, {"POS": "NOUN"}, {"POS": "ADJ"}, {"POS": "ADJ"}]
    pattern4 = [{"POS": "NOUN"}, {"POS": "ADP"}, {"POS": "DET"}, {"POS": "NOUN"}, {"POS": "ADJ"}, {"POS": "ADP"}, {"POS": "DET"}, {"POS": "ADJ"}]
    pattern5 = [{"POS": "NOUN"}, {"POS": "ADP"}, {"POS": "NOUN"}, {"POS": "ADP"}, {"POS": "NOUN"}, {"POS": "ADP"}, {"POS": "NOUN"}]
    pattern6 = [{"POS": "NOUN"}, {"POS": "ADJ"}, {"POS": "ADP"}, {"POS": "DET"}, {"POS": "NOUN"}, {"POS": "ADJ"}]
    pattern7 = [{"POS": "NOUN"}, {"POS": "ADJ"}, {"POS": "ADP"}, {"POS": "DET"}, {"POS": "NOUN"}, {"POS": "ADP"}, {"POS": "NOUN"}]
    pattern8 = [{"POS": "NOUN"}, {"POS": "ADJ"}, {"POS": "ADJ"}, {"POS": "ADP"}, {"POS": "DET"}, {"POS": "NOUN"}]
    pattern9 = [{"POS": "NOUN"}, {"POS": "ADJ"}, {"POS": "ADJ"}, {"POS": "ADJ"}, {"POS": "ADP"}, {"POS": "DET"}, {"POS": "NOUN"}]
    pattern10 = [{"POS": "NOUN"}, {"POS": "ADJ"}, {"POS": "ADJ"}, {"POS": "ADP"}, {"POS": "DET"}, {"POS": "ADJ"}, {"POS": "NOUN"}]
    pattern11 = [{"POS": "NOUN"}, {"POS": "ADJ"}, {"POS": "ADP"}, {"POS": "DET"}, {"POS": "NOUN"}, {"POS": "ADJ"}, {"POS": "ADJ"}]
    ...
    matcher.add("Concept6", None, pattern6)
    matcher.add("Concept7", None, pattern7)
    matcher.add("Concept8", None, pattern8)
    matcher.add("Concept9", None, pattern9)
    matcher.add("Concept10", None, pattern10)
    matcher.add("Concept11", None, pattern11)
...
def get_avg_and_sd_handmade(results_array):
    ...
    for line in results_array:
        ...
        dis.append(line[2])
    print("CB matrix: ", cb)
    print("Connectivity matrix: ", con)
    print("Dispersion matrix: ", dis)
...
html_doc = openFile("DoctoradoCompleto.xml")
...
output_file = open("resultados_doctorado.txt", "w+")
counter = 1
output_string = ""
results = []
for thesis in theses:
    ...
    concepts_dictionary, set_of_concepts = get_concepts_by_matching_sv(sentences)
...
avg_hm, sd_hm = get_avg_and_sd_handmade(results)
...
output_file.close()
output_string = output_string + "Average results handmade: " + "cb: " + str(avg_hm[0]) + " connectivity: " + str(avg_hm[1]) + " dispersion: " + str(avg_hm[2]) + "\n"
output_string = output_string + "Standard Deviation handmade: " + "cb: " + str(sd_hm[0]) + " connectivity: " + str(sd_hm[1]) + " dispersion: " + str(sd_hm[2]) + "\n"
