...
#   creates a dictionary of the form sec-par-sen-concepts (The concepts are
#   obtained via matching by spaCy).
...
html_doc = openFile("LicenciaturaCompleto.xml")
...
output_file = open("resultados_licenciatura.txt", "w+")
counter = 1
output_string = ""
results = []
